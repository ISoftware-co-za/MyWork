...
import 'theme_extension_control_activity_state_and_what.dart';
import 'theme_extension_dialog_base.dart';

mixin CustomThemeCommon {
  static const double paddingWide = 18.0;
  static const double paddingNarrow = 4.0;
  static Color stealBlue = Color.fromARGB(255, 70, 130, 180);

  static final ThemeExtensionSpacing spacing = ThemeExtensionSpacing(
  ...
  static final dialogBaseTheme = ThemeExtensionDialogBase(
    backgroundColor: Colors.white,
    borderColor: Color.fromARGB(255, 50, 50, 50),
    borderWidth: 4,
    dialogShadow: BoxShadow(
