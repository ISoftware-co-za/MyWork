...
class _LayoutWorkSelectorState extends State<LayoutWorkSelector> {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        SizedBox(
          width: widget._workButtonTheme.padding,
          ...
          child: GestureDetector(
            ...
            child: MouseRegion(
              ...
              child: ControlButtonSelectWork(
                ...
                workButtonTheme: widget._workButtonTheme,
  ...
  void _showWorkDialog(BuildContext context) {
    StateApplication stateProvider = ProviderStateApplication.of(
      context,
    )!.state;
    ControllerDialogWork? controller = stateProvider
        .getController<ControllerDialogWork>();
    if (controller == null) {
      CoordinatorWorkActivityList coordinator = stateProvider
          .getCoordinator<CoordinatorWorkActivityList>()!;
      controller = ControllerDialogWork(
        stateProvider.getController<ControllerWorkTypes>()!,
        coordinator,
        stateProvider.getController<ControllerNotifications>()!,
      );
      stateProvider.registerController(controller);
    }
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return LayoutDialogWork(
          controller: controller!,
          workTypes: stateProvider
              .getController<ControllerWorkTypes>()!
              .workTypes!,
          onAddWorkPressed: () => _onAddWorkPressed(context, dialogContext),
        );
      },
    );
  }

  void _onAddWorkPressed(BuildContext appContext, BuildContext dialogContext) {
    Executor.runCommand('LayoutWorkSelector', 'LayoutHeader', () {
      StateApplication applicationState = ProviderStateApplication.of(
        context,
      )!.state;
      CoordinatorWorkActivityList coordinator = applicationState
          .getCoordinator<CoordinatorWorkActivityList>()!;
      coordinator.onNewWork();
