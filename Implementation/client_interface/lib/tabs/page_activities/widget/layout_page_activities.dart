...
import 'layout_form_activity.dart';
...
class LayoutPageActivities extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ControllerWork workController = stateProvider
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, value, child) {
        if (value == null) {
          return const Center(
            child: Text(
              'No work is selected. Select work to list and manage its activities.',
            ),
          );
        }

        ThemeData themeData = Theme.of(context);
        ThemeExtensionSpacing spacingTheme = themeData
            .extension<ThemeExtensionSpacing>()!;
        ThemeExtensionControlActivityStateAndWhat
        controlActivityStateAndWhatTheme = themeData
            .extension<ThemeExtensionControlActivityStateAndWhat>()!;
        ...
        return Row(
          ...
          children: [
            SizedBox(
              width: 400,
              child: LayoutActivityListPanel(
                controller: stateProvider
                    .getController<ControllerActivityList>()!,
                spacingTheme: spacingTheme,
              ),
            ),
            Expanded(
              child: LayoutFormActivity(
                controllerActivityList: stateProvider
                    .getController<ControllerActivityList>()!,
                controllerActivity: stateProvider
                    .getController<ControllerActivity>()!,
                spacingTheme: spacingTheme,
