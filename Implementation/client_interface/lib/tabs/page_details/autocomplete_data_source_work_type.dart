...
class AutocompleteDataSourceWorkType extends AutocompleteDataSource {

  AutocompleteDataSourceWorkType(String userID, WorkTypeList workTypes, StateProperty<String>? property)
